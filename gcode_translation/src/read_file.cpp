...
int main(int argc, char **argv)
{
  ...
  std::ifstream inputFile("/home/arthur/git_ws/moveo_moveit_ws/src/gcode_translation/src/75mm test.gcode");
  std::ofstream outfile ("/home/arthur/git_ws/moveo_moveit_ws/src/gcode_translation/src/75mm test_new.gcode");
  std::string line;
