...
//joint
#define HOMING_BUMP_DIVISOR_Joint {24, 10, 3, 6, 3}
...
#define MANUAL1_FEEDRATE {15 * 60, 45 * 60, 100 * 60, 50 * 60, 5 * 60}
#define MANUAL2_FEEDRATE {0.3 * 60, 0.6 * 60, 1.8 * 60, 2 * 60, 2 * 60}
